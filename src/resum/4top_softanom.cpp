...
Eigen::Matrix<complex<double>, 6, 6> get_S1tilde(kinematic_invariants & KI){
    assert(INCEULER == 0 && "Cannot handle the euler factor now!");
    ...
    //set_threshold();
    S1tilde11 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((-1 + pow(CA,2))*((4*KI.DL34 + 4*KI.DL56 + KI.L2beta34 + KI.L2beta56 + 2*KI.Lbeta3 + 2*KI.Lbeta4 + 2*KI.Lbeta5 + 2*KI.Lbeta6)/8. + ((2 + KI.L34 + KI.L56)*log(muR2/M2))/2.))/CA;
    S1tilde12 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(-((4*KI.DL35 - 4*KI.DL36 - 4*KI.DL45 + 4*KI.DL46 + KI.L2beta35 - KI.L2beta36 - KI.L2beta45 + KI.L2beta46)*sqrt(-1 + pow(CA,2)))/8. - ((KI.L35 - KI.L36 - KI.L45 + KI.L46)*sqrt(-1 + pow(CA,2))*log(muR2/M2))/2.)/CA;
    S1tilde13 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((sqrt(-1 + pow(CA,2))*(KI.DLc15 - KI.DLc16 - KI.DLc25 + KI.DLc26 + KI.T15 + pow(KI.T15,2) - KI.T16 - pow(KI.T16,2) - KI.T25 - pow(KI.T25,2) + KI.T26 + pow(KI.T26,2)))/2. + (sqrt(-1 + pow(CA,2))*(-KI.T15 + KI.T16 + KI.T25 - KI.T26)*log(muR2/M2))/2.)/CA;
    S1tilde14 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((sqrt(-1 + pow(CA,2))*(KI.DLc13 - KI.DLc14 - KI.DLc23 + KI.DLc24 + KI.T13 + pow(KI.T13,2) - KI.T14 - pow(KI.T14,2) - KI.T23 - pow(KI.T23,2) + KI.T24 + pow(KI.T24,2)))/2. + (sqrt(-1 + pow(CA,2))*(-KI.T13 + KI.T14 + KI.T23 - KI.T24)*log(muR2/M2))/2.)/CA;
    S1tilde15 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *0;
    S1tilde16 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *0;
    S1tilde22 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *CA*((4*KI.DL36 + 4*KI.DL45 + KI.L2beta36 + KI.L2beta45 + 2*KI.Lbeta3 + 2*KI.Lbeta4 + 2*KI.Lbeta5 + 2*KI.Lbeta6)/8. - ((-8 - 4*KI.L36 - 4*KI.L45)*log(muR2/M2))/8.) + ((-4*KI.DL34 + 8*KI.DL35 - 8*KI.DL36 - 8*KI.DL45 + 8*KI.DL46 - 4*KI.DL56 - KI.L2beta34 + 2*KI.L2beta35 - 2*KI.L2beta36 - 2*KI.L2beta45 + 2*KI.L2beta46 - KI.L2beta56 - 2*KI.Lbeta3 - 2*KI.Lbeta4 - 2*KI.Lbeta5 - 2*KI.Lbeta6)/8. - ((8 + 4*KI.L34 - 8*KI.L35 + 8*KI.L36 + 8*KI.L45 - 8*KI.L46 + 4*KI.L56)*log(muR2/M2))/8.)/CA;
    S1tilde23 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((KI.DLc13 - KI.DLc14 - KI.DLc23 + KI.DLc24 + KI.T13 + pow(KI.T13,2) - KI.T14 - pow(KI.T14,2) - KI.T23 - pow(KI.T23,2) + KI.T24 + pow(KI.T24,2))/2. + ((-KI.T13 + KI.T14 + KI.T23 - KI.T24)*log(muR2/M2))/2.)/CA;
    S1tilde24 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((KI.DLc15 - KI.DLc16 - KI.DLc25 + KI.DLc26 + KI.T15 + pow(KI.T15,2) - KI.T16 - pow(KI.T16,2) - KI.T25 - pow(KI.T25,2) + KI.T26 + pow(KI.T26,2))/2. + ((-KI.T15 + KI.T16 + KI.T25 - KI.T26)*log(muR2/M2))/2.)/CA;
    S1tilde25 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((sqrt(-4 + pow(CA,2))*(KI.DLc13 - KI.DLc14 + KI.DLc15 - KI.DLc16 - KI.DLc23 + KI.DLc24 - KI.DLc25 + KI.DLc26 + KI.T13 + pow(KI.T13,2) - KI.T14 - pow(KI.T14,2) + KI.T15 + pow(KI.T15,2) - KI.T16 - pow(KI.T16,2) - KI.T23 - pow(KI.T23,2) + KI.T24 + pow(KI.T24,2) - KI.T25 - pow(KI.T25,2) + KI.T26 + pow(KI.T26,2)))/(2.*sqrt(2)) + (sqrt(-4 + pow(CA,2))*(-KI.T13 + KI.T14 - KI.T15 + KI.T16 + KI.T23 - KI.T24 + KI.T25 - KI.T26)*log(muR2/M2))/(2.*sqrt(2)))/CA;
    S1tilde26 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(-KI.DLc13 - KI.DLc14 + KI.DLc15 + KI.DLc16 + KI.DLc23 + KI.DLc24 - KI.DLc25 - KI.DLc26 - KI.T13 - pow(KI.T13,2) - KI.T14 - pow(KI.T14,2) + KI.T15 + pow(KI.T15,2) + KI.T16 + pow(KI.T16,2) + KI.T23 + pow(KI.T23,2) + KI.T24 + pow(KI.T24,2) - KI.T25 - pow(KI.T25,2) - KI.T26 - pow(KI.T26,2))/(2.*sqrt(2)) + ((KI.T13 + KI.T14 - KI.T15 - KI.T16 - KI.T23 - KI.T24 + KI.T25 + KI.T26)*log(muR2/M2))/(2.*sqrt(2));
    S1tilde33 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *CA*((2 + 4*KI.DL34 + 4*KI.DLc15 + 4*KI.DLc26 + KI.L2beta34 + 2*KI.Lbeta3 + 2*KI.Lbeta4 + 2*KI.Lbeta5 + 2*KI.Lbeta6 + 4*KI.T15 + 4*pow(KI.T15,2) + 4*KI.T26 + 4*pow(KI.T26,2))/8. + ((4 + 4*KI.L34 - 4*KI.T15 - 4*KI.T26)*log(muR2/M2))/8.) + ((-4*KI.DL34 - 4*KI.DL56 - 8*KI.DLc15 + 8*KI.DLc16 + 8*KI.DLc25 - 8*KI.DLc26 - KI.L2beta34 - KI.L2beta56 - 2*KI.Lbeta3 - 2*KI.Lbeta4 - 2*KI.Lbeta5 - 2*KI.Lbeta6 - 8*KI.T15 - 8*pow(KI.T15,2) + 8*KI.T16 + 8*pow(KI.T16,2) + 8*KI.T25 + 8*pow(KI.T25,2) - 8*KI.T26 - 8*pow(KI.T26,2))/8. + ((-8 - 4*KI.L34 - 4*KI.L56 + 8*KI.T15 - 8*KI.T16 - 8*KI.T25 + 8*KI.T26)*log(muR2/M2))/8.)/CA;
    S1tilde34 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *((-4*KI.DL35 + 4*KI.DL36 + 4*KI.DL45 - 4*KI.DL46 - KI.L2beta35 + KI.L2beta36 + KI.L2beta45 - KI.L2beta46)/8. - ((KI.L35 - KI.L36 - KI.L45 + KI.L46)*log(muR2/M2))/2.)/CA;
    S1tilde35 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(-(sqrt(-4 + pow(CA,2))*(4*KI.DL35 - 4*KI.DL36 - 4*KI.DL45 + 4*KI.DL46 - 4*KI.DLc13 + 4*KI.DLc14 + 4*KI.DLc23 - 4*KI.DLc24 + KI.L2beta35 - KI.L2beta36 - KI.L2beta45 + KI.L2beta46 - 4*KI.T13 - 4*pow(KI.T13,2) + 4*KI.T14 + 4*pow(KI.T14,2) + 4*KI.T23 + 4*pow(KI.T23,2) - 4*KI.T24 - 4*pow(KI.T24,2)))/(8.*sqrt(2)) - (sqrt(-4 + pow(CA,2))*(KI.L35 - KI.L36 - KI.L45 + KI.L46 + KI.T13 - KI.T14 - KI.T23 + KI.T24)*log(muR2/M2))/(2.*sqrt(2)))/CA;
    S1tilde36 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(4*KI.DL35 + 4*KI.DL36 - 4*KI.DL45 - 4*KI.DL46 - 4*KI.DLc13 + 4*KI.DLc14 - 4*KI.DLc23 + 4*KI.DLc24 + KI.L2beta35 + KI.L2beta36 - KI.L2beta45 - KI.L2beta46 - 4*KI.T13 - 4*pow(KI.T13,2) + 4*KI.T14 + 4*pow(KI.T14,2) - 4*KI.T23 - 4*pow(KI.T23,2) + 4*KI.T24 + 4*pow(KI.T24,2))/(8.*sqrt(2)) + ((KI.L35 + KI.L36 - KI.L45 - KI.L46 + KI.T13 - KI.T14 + KI.T23 - KI.T24)*log(muR2/M2))/(2.*sqrt(2));
    S1tilde44 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *CA*((2 + 4*KI.DL56 + 4*KI.DLc13 + 4*KI.DLc24 + KI.L2beta56 + 2*KI.Lbeta3 + 2*KI.Lbeta4 + 2*KI.Lbeta5 + 2*KI.Lbeta6 + 4*KI.T13 + 4*pow(KI.T13,2) + 4*KI.T24 + 4*pow(KI.T24,2))/8. + ((4 + 4*KI.L56 - 4*KI.T13 - 4*KI.T24)*log(muR2/M2))/8.) + ((-4*KI.DL34 - 4*KI.DL56 - 8*KI.DLc13 + 8*KI.DLc14 + 8*KI.DLc23 - 8*KI.DLc24 - KI.L2beta34 - KI.L2beta56 - 2*KI.Lbeta3 - 2*KI.Lbeta4 - 2*KI.Lbeta5 - 2*KI.Lbeta6 - 8*KI.T13 - 8*pow(KI.T13,2) + 8*KI.T14 + 8*pow(KI.T14,2) + 8*KI.T23 + 8*pow(KI.T23,2) - 8*KI.T24 - 8*pow(KI.T24,2))/8. + ((-8 - 4*KI.L34 - 4*KI.L56 + 8*KI.T13 - 8*KI.T14 - 8*KI.T23 + 8*KI.T24)*log(muR2/M2))/8.)/CA;
    S1tilde45 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(-(sqrt(-4 + pow(CA,2))*(4*KI.DL35 - 4*KI.DL36 - 4*KI.DL45 + 4*KI.DL46 - 4*KI.DLc15 + 4*KI.DLc16 + 4*KI.DLc25 - 4*KI.DLc26 + KI.L2beta35 - KI.L2beta36 - KI.L2beta45 + KI.L2beta46 - 4*KI.T15 - 4*pow(KI.T15,2) + 4*KI.T16 + 4*pow(KI.T16,2) + 4*KI.T25 + 4*pow(KI.T25,2) - 4*KI.T26 - 4*pow(KI.T26,2)))/(8.*sqrt(2)) - (sqrt(-4 + pow(CA,2))*(KI.L35 - KI.L36 - KI.L45 + KI.L46 + KI.T15 - KI.T16 - KI.T25 + KI.T26)*log(muR2/M2))/(2.*sqrt(2)))/CA;
    S1tilde46 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(-4*KI.DL35 + 4*KI.DL36 - 4*KI.DL45 + 4*KI.DL46 + 4*KI.DLc15 - 4*KI.DLc16 + 4*KI.DLc25 - 4*KI.DLc26 - KI.L2beta35 + KI.L2beta36 - KI.L2beta45 + KI.L2beta46 + 4*KI.T15 + 4*pow(KI.T15,2) - 4*KI.T16 - 4*pow(KI.T16,2) + 4*KI.T25 + 4*pow(KI.T25,2) - 4*KI.T26 - 4*pow(KI.T26,2))/(8.*sqrt(2)) - ((KI.L35 - KI.L36 + KI.L45 - KI.L46 + KI.T15 - KI.T16 + KI.T25 - KI.T26)*log(muR2/M2))/(2.*sqrt(2));
    S1tilde55 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *CA*((4 + 4*KI.DL36 + 4*KI.DL45 + 4*KI.DLc13 + 4*KI.DLc15 + 4*KI.DLc24 + 4*KI.DLc26 + KI.L2beta36 + KI.L2beta45 + 4*KI.Lbeta3 + 4*KI.Lbeta4 + 4*KI.Lbeta5 + 4*KI.Lbeta6 + 4*KI.T13 + 4*pow(KI.T13,2) + 4*KI.T15 + 4*pow(KI.T15,2) + 4*KI.T24 + 4*pow(KI.T24,2) + 4*KI.T26 + 4*pow(KI.T26,2))/16. + ((8 + 4*KI.L36 + 4*KI.L45 - 4*KI.T13 - 4*KI.T15 - 4*KI.T24 - 4*KI.T26)*log(muR2/M2))/16.) + ((-8*KI.DL34 + 24*KI.DL35 - 24*KI.DL36 - 24*KI.DL45 + 24*KI.DL46 - 8*KI.DL56 - 24*KI.DLc13 + 24*KI.DLc14 - 24*KI.DLc15 + 24*KI.DLc16 + 24*KI.DLc23 - 24*KI.DLc24 + 24*KI.DLc25 - 24*KI.DLc26 - 2*KI.L2beta34 + 6*KI.L2beta35 - 6*KI.L2beta36 - 6*KI.L2beta45 + 6*KI.L2beta46 - 2*KI.L2beta56 - 4*KI.Lbeta3 - 4*KI.Lbeta4 - 4*KI.Lbeta5 - 4*KI.Lbeta6 - 24*KI.T13 - 24*pow(KI.T13,2) + 24*KI.T14 + 24*pow(KI.T14,2) - 24*KI.T15 - 24*pow(KI.T15,2) + 24*KI.T16 + 24*pow(KI.T16,2) + 24*KI.T23 + 24*pow(KI.T23,2) - 24*KI.T24 - 24*pow(KI.T24,2) + 24*KI.T25 + 24*pow(KI.T25,2) - 24*KI.T26 - 24*pow(KI.T26,2))/16. + ((-16 - 8*KI.L34 + 24*KI.L35 - 24*KI.L36 - 24*KI.L45 + 24*KI.L46 - 8*KI.L56 + 24*KI.T13 - 24*KI.T14 + 24*KI.T15 - 24*KI.T16 - 24*KI.T23 + 24*KI.T24 - 24*KI.T25 + 24*KI.T26)*log(muR2/M2))/16.)/CA;
    S1tilde56 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *(sqrt(-4 + pow(CA,2))*(4*KI.DL36 - 4*KI.DL45 - 4*KI.DLc13 + 4*KI.DLc15 + 4*KI.DLc24 - 4*KI.DLc26 + KI.L2beta36 - KI.L2beta45 - 4*KI.T13 - 4*pow(KI.T13,2) + 4*KI.T15 + 4*pow(KI.T15,2) + 4*KI.T24 + 4*pow(KI.T24,2) - 4*KI.T26 - 4*pow(KI.T26,2)))/16. + (sqrt(-4 + pow(CA,2))*(KI.L36 - KI.L45 + KI.T13 - KI.T15 - KI.T24 + KI.T26)*log(muR2/M2))/4.;
    S1tilde66 = include_S1*ISNLL*alphas_muR/M_PI*ONLY_SF*s1_piece *CA*((4 + 4*KI.DL36 + 4*KI.DL45 + 4*KI.DLc13 + 4*KI.DLc15 + 4*KI.DLc24 + 4*KI.DLc26 + KI.L2beta36 + KI.L2beta45 + 4*KI.Lbeta3 + 4*KI.Lbeta4 + 4*KI.Lbeta5 + 4*KI.Lbeta6 + 4*KI.T13 + 4*pow(KI.T13,2) + 4*KI.T15 + 4*pow(KI.T15,2) + 4*KI.T24 + 4*pow(KI.T24,2) + 4*KI.T26 + 4*pow(KI.T26,2))/16. + ((8 + 4*KI.L36 + 4*KI.L45 - 4*KI.T13 - 4*KI.T15 - 4*KI.T24 - 4*KI.T26)*log(muR2/M2))/16.) + ((-8*KI.DL34 + 8*KI.DL35 - 8*KI.DL36 - 8*KI.DL45 + 8*KI.DL46 - 8*KI.DL56 - 8*KI.DLc13 + 8*KI.DLc14 - 8*KI.DLc15 + 8*KI.DLc16 + 8*KI.DLc23 - 8*KI.DLc24 + 8*KI.DLc25 - 8*KI.DLc26 - 2*KI.L2beta34 + 2*KI.L2beta35 - 2*KI.L2beta36 - 2*KI.L2beta45 + 2*KI.L2beta46 - 2*KI.L2beta56 - 4*KI.Lbeta3 - 4*KI.Lbeta4 - 4*KI.Lbeta5 - 4*KI.Lbeta6 - 8*KI.T13 - 8*pow(KI.T13,2) + 8*KI.T14 + 8*pow(KI.T14,2) - 8*KI.T15 - 8*pow(KI.T15,2) + 8*KI.T16 + 8*pow(KI.T16,2) + 8*KI.T23 + 8*pow(KI.T23,2) - 8*KI.T24 - 8*pow(KI.T24,2) + 8*KI.T25 + 8*pow(KI.T25,2) - 8*KI.T26 - 8*pow(KI.T26,2))/16. + ((-16 - 8*KI.L34 + 8*KI.L35 - 8*KI.L36 - 8*KI.L45 + 8*KI.L46 - 8*KI.L56 + 8*KI.T13 - 8*KI.T14 + 8*KI.T15 - 8*KI.T16 - 8*KI.T23 + 8*KI.T24 - 8*KI.T25 + 8*KI.T26)*log(muR2/M2))/16.)/CA;
    S1tilde21 = S1tilde12;
    S1tilde31 = S1tilde13;
    S1tilde41 = S1tilde14;
    S1tilde51 = 0;
