...
int configure(int ac, char* av[], string configfile, bool runupdate = true)
{
    try {
        ...
        hidden.add_options()
            ...
            ("ONLY_SF", po::value<double>(&ONLY_SF)->default_value(0), "include scale term")
            ...
            ("cusp_piece_LO", po::value<double>(&cusp_piece_LO)->default_value(1), "include cusp LO")
            ("cusp_piece_NLO", po::value<double>(&cusp_piece_NLO)->default_value(1), "include cusp NLO")
            ("ws_piece", po::value<double>(&wide_soft_piece)->default_value(1), "include wide-angle soft")
            ("s1_piece", po::value<double>(&s1_piece)->default_value(1), "include S1")
            ("c1_piece", po::value<double>(&c1_piece)->default_value(1), "include C1")
            ("b0_piece", po::value<double>(&b0_piece)->default_value(1), "include b0")
            //scales
