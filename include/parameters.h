...
//settings
extern bool realPDF, fitPDF, LO, expansion, NLL_truncated;
extern double INCEULER;
extern double ISLL;
extern double ISNLL;
extern double ONLY_SF;
extern double cusp_piece_LO, cusp_piece_NLO, cusp_piece, wide_soft_piece, s1_piece, c1_piece, b0_piece;
